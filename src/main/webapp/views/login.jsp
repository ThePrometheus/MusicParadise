                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <form id="register-form" action="/client/register" method="post"
                                ...
                                <div class="form-group">
                                    <input type="text" name="real_name" id="sur_name" tabindex="1" class="form-control"
                                           placeholder="Surname" value="" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="real_name" id="first_name" tabindex="1" class="form-control"
                                           placeholder="Firstname" value="" required>
                                </div>
                                <div class="form-group">
                                    <input type="text" name="real_name" id="middle_name" tabindex="1" class="form-control"
                                           placeholder="Middlename" value="" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input type="tel" name="phone_num" id="phone_num" tabindex="1" class="form-control"
                                           placeholder="Telephonne number" value="" pattern="\+380[0-9]{9}" required>
                                </div>
                                <div class="form-group">
